        ...
        <Container>
          <div className="flex justify-between gap-8">
            ...
            <div className="w-1/2">
              ...
              <br />
              <Body>Bid on this exclusive item available for auction! This is a fantastic opportunity to own a high-quality product. Whether you're looking to add to your collection, upgrade your current items, or simply take advantage of a great deal, this auction offers something for everyone.
               The item is in condition, and is ready to be added to your collection. Don't miss out on this chance to place your bid and potentially take home something truly special.</Body>
              <br />
          ...
          <table className="w-full text-sm text-left rtl:text-right text-gray-500">
            ...
            <tbody>
              <tr className="bg-white border-b hover:bg-gray-50">
                <td className="px-6 py-4">November 11, 2024 2:40 pm</td>
                <td className="px-6 py-4">$600</td>
                <td className="px-6 py-4">Ashutosh Ranjan</td>
