        ...
        <table className="w-full text-sm text-left rtl:text-right text-gray-500">
          ...
          <tbody>
            <tr className="bg-white border-b hover:bg-gray-50">
              ...
              <td className="px-6 py-4 capitalize">Ashutosh Ranjan</td>
              <td className="px-6 py-4">ranjanashutosh058@gmail.com</td>
              <td className="px-6 py-4 capitalize">User</td>
              <td className="px-6 py-4">
                <ProfileCard>
                  <img src={User2} alt={User2} />
                </ProfileCard>
              </td>
              <td className="px-6 py-4">Nov 16 2024</td>
